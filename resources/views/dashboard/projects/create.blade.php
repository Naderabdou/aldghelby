                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.blogs.index') }}">المشاريع</a>
                                    </li>
                                ...
                                <div class="card-body">
                                    <form class="form form-vertical" id="createBookForm"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="name_ar">الاسم باللغه الانجليزيه</label>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea required class="form-control" name="desc_ar" id="desc_ar" rows="5">{{ old('desc_ar') }}</textarea>
                                                    @error('desc_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea required class="form-control" name="desc_en" id="desc_en" rows="5">{{ old('desc_en') }}</textarea>
                                                    @error('desc_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
