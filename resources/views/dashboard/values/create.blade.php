                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.features.index') }}"> القيم </a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">اضافة قيمة  </a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">اضافة قيمة  </h2>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="title_ar" class="form-control"
                                                        name="title_ar" required value="{{ old('title_ar') }}" />
                                                    @error('title_ar')
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="title_en" class="form-control"
                                                        name="title_en" required value="{{ old('title_en') }}" />
                                                    @error('title_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="services_ar" id="description_ar"  rows="5" required>{{ old('services_ar') }}</textarea>
                                                    @error('services_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="services_en" id="description_en"  rows="5" required>{{ old('services_en') }}</textarea>
                                                    @error('services_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
