                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">تعديل الخدمات</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                    href="{{ route('admin.services.create') }}"><i class="mr-1"
                                        data-feather="check-square"></i><span class="align-middle">اضافة خدمات
                                        جديد</span></a></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">تعديل خدمات</h2>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_en" class="form-control" name="name_en"
                                                        required value="{{ old('name_en', $service->name_en) }}" />
                                                    @error('name_en')
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_ar" class="form-control" name="name_ar"
                                                        required value="{{ old('name_ar', $service->name_ar) }}" />
                                                    @error('name_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
