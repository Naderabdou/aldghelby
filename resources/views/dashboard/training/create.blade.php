                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-vertical" id="createBookForm"
                                        action="{{ route('admin.training.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="desc_ar" id="desc_ar" rows="5">{{ old('description_en') }}</textarea>
                                                    @error('desc_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="desc_en" id="desc_en" rows="5">{{ old('description_en') }}</textarea>
                                                    @error('desc_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
