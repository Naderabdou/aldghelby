                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.client.index') }}">اراء العملاء</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">اضافة راي العميل </a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">اضافة راي العميل</h2>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="name_ar"> اسم العميل بالعربي </label>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="name_en">اسم العميل بالانجليزي </label>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="desc">رأي العميل بالعربي</label>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="desc">رأي العميل بالانجليزي</label>
